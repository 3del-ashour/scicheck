...
``contracts.Evidence`` Pydantic model."""RAG service. Owner: Member 2.
...
def retrieve(query: str, k: int = 5) -> list[Evidence]:
    ...
    try:
        ...
        for source_id, doc_text, meta, dist in zip(
            ...
            evidence_list.append(
                Evidence(
                    ...
                    metadata={key: v for key, v in meta.items() if key != "title"},
                )
            )
